...
def select_course(ID, course_list, headers):
    ...
    param = {
        'addParam': '{"data":{"operationType":"1","studentCode":' + student_ID + ',"electiveBatchCode'
                                                                                 '":"1a10492bc4054f61a95d4e0be1aa0a15'
                                                                                 '","teachingClassId":' +
                    teachingClassId + ',"isMajor":"1","campus":"1","teachingClassType":"FAWKC"}} '
    }
